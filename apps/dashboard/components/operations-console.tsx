...
type Scan = { scanId: string; releaseId: string; policyHash: string; status: string; stage: string; attempts: number; maxAttempts: number; traceId: string; createdAt: string; updatedAt: string; nextAttemptAt: string; lastError?: unknown; result?: { scanResult?: { scanStatus?: string } } };
